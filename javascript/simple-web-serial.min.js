...
!(function (e, t) {
    "object" == typeof exports && "object" == typeof module ? (module.exports = t()) : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? (exports.SimpleWebSerial = t()) : (e.SimpleWebSerial = t());
})(globalThis, () =>
    (() => {
        "use strict";
        var e = {};
        ...
        e.r(t), e.d(t, { LineBreakTransformer: () => o, setupSerialConnection: () => l, DEFAULT_BAUDRATE: () => i });
        let i = 57600;
        class o {
            transform(e, t) {
                try {
            ...
            constructor(e = "\r\n") {
                r(this, "chunks", void 0), r(this, "delimiter", void 0), (this.chunks = ""), (this.delimiter = e);
            }
        }
        function n(e) {
            if ("number" == typeof e) return e;
            if ("string" == typeof e && !Number.isNaN(+e) && "" !== e.trim()) return parseFloat(e);
        ...
        class a {
            ...
            createModal() {
                let [e, t, r, i, o, n, s] = ["div", "div", "div", "div", "p", "p", "button"].map((e) => document.createElement(e));
                r.classList.add("SimpleWebSerial-modal-container"),
                    ...
                    this.configuration.styleDomElements &&
                        (e.setAttribute("style", "position: fixed; left: 0; top: 0; width: 100%; height: 100%; z-index: 10000"),
                        t.setAttribute("style", "background-color: rgba(0,0,0,.3); position: absolute; left: 0; top: 0; width: 100%; height: 100%; cursor: pointer"),
                        r.setAttribute("style", "position: absolute; width: 100%; height: auto; padding: 4rem; box-sizing: border-box;"),
                        i.setAttribute("style", "background-color: #fff; border-radius: 4px; padding: 1rem; box-shadow: 0px 2px 11px 4px rgba(0,0,0, .09);"),
            ...
            async startConnection() {
                if (this.ready()) throw Error("Serial connection has already been established.");
                try {
                    (this.port = await navigator.serial.requestPort({ filters: this.configuration.filters })), await this.port.open({ baudRate: this.configuration.baudRate });
                } catch (e) {
                    throw (this.showErrorMessageInModal("There was an error trying to open a serial connection. Please make sure the port is not occupied in another tab or process. Error message:<br>" + e), e);
                }
                ...
                e.readable.pipeTo(this.port.writable), this.port.readable.pipeTo(t.writable);
                let r = t.readable.pipeThrough(new TransformStream(this.configuration.transformer)).getReader();
            ...
            on(e, t) {
                return !this._listeners[e] && (this._listeners[e] = []), this._listeners[e].push(t), [e, t];
            }
            removeListener(e, t) {
                let r;
                ...
                if (!this._listeners[r]) throw Error("There is no listener named " + r + ".");
                let i = this._listeners[r].length;
                return (this._listeners[r] = this._listeners[r].filter((e) => e !== t)), i !== this._listeners[r].length;
            }
            removeListeners(e) {
                var t;
                if ("string" != typeof e) throw Error("removeListeners expects a string as parameter, which will be used to remove all listeners of that event.");
                let r = (null === (t = this._listeners[e]) || void 0 === t ? void 0 : t.length) || 0;
                return (this._listeners[e] = []), r > 0;
            }
            ready() {
                var e, t;
                return !!((null === (e = this.port) || void 0 === e ? void 0 : e.readable) && (null === (t = this.port) || void 0 === t ? void 0 : t.writable));
            }
            readable() {
                var e;
                return (null === (e = this.port) || void 0 === e ? void 0 : e.readable) || null;
            }
            writable() {
                var e;
                return (null === (e = this.port) || void 0 === e ? void 0 : e.writable) || null;
            }
            async send(e, t) {
                var r;
                let i;
                if (!(null === (r = this.port) || void 0 === r ? void 0 : r.writable) || !this.writer) return;
                void 0 === t ? (this.configuration.logOutgoingSerialData && console.log(e), this.configuration.parseStringsAsNumbers && (e = n(e)), (i = ["_d", e])) : (this.configuration.parseStringsAsNumbers && (t = n(t)), (i = [e, t]));
                let o = JSON.stringify(i);
                this.configuration.logOutgoingSerialData && console.log(o), await this.writer.write(o + this.configuration.newLineCharacter);
            }
            async sendEvent(e) {
            ...
            emit(e, t) {
                this._listeners[e] ? this._listeners[e].forEach((e) => e(t)) : this.configuration.warnAboutUnregisteredEvents && console.warn("Event " + e + " has been received, but it has never been registered as listener.");
            }
            async readLoop(e) {
                for (;;) {
                    ...
                    if (t) {
                        ...
                        try {
                            ...
                            this.configuration.logIncomingSerialData && console.warn("Failed to parse serial data:", t, "| Reported error:", e);
                        }
                        if (e) {
                            if ((this.configuration.logIncomingSerialData && console.log(e), Array.isArray(e)))
                                switch (e[0]) {
                                    case "_w":
        ...
        function l(e) {
            let t;
            if (!navigator.serial) throw Error("The Serial API is not supported in your browser. Make sure you've enabled flags if necessary!");
            ...
            let r = new a(t);
            return t.requestElement && r.requestSerialAccessOnClick(t.requestElement), t.requestAccessOnPageLoad && window.addEventListener("load", r.createModal), r;
        }
        return t;
    })()
);
